  ...
  query.onSnapshot(function(snapshot) {
    snapshot.docChanges().forEach(function(change) {
      if (change.type === 'removed') {
        ...
        if(message.residence == getUserDorm() || message.residence == "UNC"){
...
// Checks for clicks on user names to go to profile page.
var profileButtonElement  = document.getElementById('profile');
if(profileButtonElement != null){
  profileButtonElement.addEventListener('click', viewProfile);
}
...
setTimeout(function(){ superHead.innerText = "The "+getUserDorm()+" Lounge" }, 1000);
setTimeout(function(){ console.log(getUserDorm()) }, 1000);
setTimeout(function(){ if(getUserDorm() == null){alert("Please click the profile button and set a dorm!");} }, 1000);
